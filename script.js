...
const translations = {
    en: {
        ...
        "game5-title": "Wuthering Waves", "game6-title": "Neverness To Everness",
        "profile-title": "All social IDs are @aruiroha0718.", "profile-desc": "My goal is to build global relationships with more people around the world through a variety of content, and I will continue to publish a lot of content."
    },
    ja: {
        ...
        "game5-title": "鳴潮 (Wuthering Waves)", "game6-title": "ネヴァネス・トゥ・エヴァネス",
        "profile-title": "全てのSNS IDは @aruiroha0718 です。", "profile-desc": "様々なコンテンツを通じて、より多くの世界中の人々とグローバルな関係を築くことを目標とし、これからもたくさんのコンテンツを公開していきます。"
    },
    ko: {
        ...
        "game5-title": "명조: 워더링 웨이브", "game6-title": "네버니스 투 에버니스",
        "profile-title": "모든 소셜 ID는 @aruiroha0718 입니다.", "profile-desc": "다양한 콘텐츠를 통해 더 많은 세계인들과 글로벌한 관계를 구축하는 것을 목표로, 앞으로도 많은 콘텐츠를 공개할 예정입니다."
    }
};
